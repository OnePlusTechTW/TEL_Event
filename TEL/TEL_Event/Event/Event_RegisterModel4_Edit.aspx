<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Event.master" AutoEventWireup="true" CodeFile="Event_RegisterModel4_Edit.aspx.cs" Inherits="Event_Event_RegisterModel4_Edit" StylesheetTheme="Event" Culture="auto" UICulture="auto" meta:resourcekey="PageResource2" %>
                ...
                <tr>
                    <td>
                        <asp:RadioButtonList ID="rblNeedhotel" runat="server" CssClass="controlCommon" AutoPostBack="True" OnSelectedIndexChanged="rblNeedhotel_SelectedIndexChanged" meta:resourcekey="rblNeedhotelResource1">
                            <asp:ListItem Value="是" meta:resourcekey="ListItemResource17">是</asp:ListItem>
                            <asp:ListItem Value="否" Selected="True" meta:resourcekey="ListItemResource18">否</asp:ListItem>
                        </asp:RadioButtonList>
                    </td>
                    <td colspan="2" style="vertical-align: top">
