...
public partial class Event_Event_Create : System.Web.UI.Page
{
    ...
    protected void btnNextStep_Click(object sender, EventArgs e)
    {
        ...
        EventsData.Add("id", string.IsNullOrEmpty(id) ? Guid.NewGuid().ToString() : id);//活動名稱
        ...
        EventsData.Add("description", Microsoft.Security.Application.Encoder.HtmlEncode(txtEditor.Text));//活動成員 郵件群組自填
