            ...
            <td colspan="3">
                <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                    <ContentTemplate>
                        <div>
                            <div>
                                <asp:RadioButtonList ID="rblEventMember" runat="server" RepeatDirection="Horizontal" OnSelectedIndexChanged="rblEventMember_SelectedIndexChanged" AutoPostBack="true">
                            ...
                            <div>
                                <div>
                                    <asp:CheckBoxList ID="cblCustMember" runat="server" Visible="false">
                                    </asp:CheckBoxList>
                                </div>
