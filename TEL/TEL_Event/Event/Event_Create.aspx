<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Event.master" AutoEventWireup="true" CodeFile="Event_Create.aspx.cs" Inherits="Event_Event_Create" StylesheetTheme="Event" Culture="auto" UICulture="auto" meta:resourcekey="PageResource2" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <table>
        <tr>
            <td>
                <asp:Image runat="server" ImageUrl="~/Master/images/Link_CreateEvents.png" Height="40px" meta:resourcekey="ImageResource1"></asp:Image>
            </td>
    ...
    <table>
        ...
        <tr>
            <td colspan="3">
                ...
                <asp:Label ID="lblOrtherEventManager2" runat="server" Text="(請輸入工號並以逗號隔開)" meta:resourcekey="lblOrtherEventManager2Resource1"></asp:Label>
            </td>
        </tr>
        <tr>
            <td colspan="3">
                        ...
                        <div>
                            ...
                            <div>
                                ...
                                <div style="display: flex">
                                    ...
                                    <div style="display: inline-table;">
                                        <asp:Label ID="lblCustMember" runat="server" Text="(請輸入工號並以逗號隔開)" Style="font-size: 17px;" Visible="False" meta:resourcekey="lblCustMemberResource1"></asp:Label>
                                    </div>
                                </div>
                            </div>
                        </div>
