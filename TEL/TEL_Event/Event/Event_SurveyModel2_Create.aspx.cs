...
public partial class Event_SurveyModel2_Create : System.Web.UI.Page
{
    ...
    protected bool Save_Data()
    {
        ...
        errormsg = sv.SaveSurveyDataMModel2(this.Request.QueryString["id"], Page.Session["EmpID"].ToString(), q1, q1other, q2, q3, q4, q5, q6, this.FIELD_Q7.Text.Trim(), this.FIELD_Q8.Text.Trim());
