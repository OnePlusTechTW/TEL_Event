<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Event.master" AutoEventWireup="true" CodeFile="Event_RegisterModel3_Edit.aspx.cs" Inherits="Event_Event_RegisterModel3_Edit" StylesheetTheme="Event" Culture="auto" UICulture="auto" meta:resourcekey="PageResource2" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <script>
        ...
        function onDelete(id) {
            PageMethods.DeleteRegisterModel3(id, Success, Failure);
        }
        ...
        <ContentTemplate>
            <table>
                ...
                <tr class="FormTRStyle">
                    ...
                    <td>
                        <asp:Label ID="lblExamineename" runat="server" Text="受診者中文姓名" meta:resourcekey="lblExamineenameResource1"></asp:Label>
                    </td>
                    <td>
                        <asp:Label ID="lblExamineeidno" runat="server" Text="受診者身分證字號" meta:resourcekey="lblExamineeidnoResource1"></asp:Label>
                    </td>
                    <td>
                ...
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="txtExamineebirthday" runat="server" CssClass="QueryField" meta:resourcekey="txtExamineebirthdayResource1"></asp:TextBox>
                    </td>
                    <td>
                ...
                <tr>
                    ...
                    <td class="auto-style1">
                        <asp:DropDownList ID="ddlArea" runat="server" CssClass="QueryField" Width="100%" AutoPostBack="True" OnSelectedIndexChanged="ddlArea_SelectedIndexChanged" meta:resourcekey="ddlAreaResource1">
                            <asp:ListItem Selected="True" Value="" meta:resourcekey="ListItemResource5">- 未指定 -</asp:ListItem>
                        </asp:DropDownList>
                    </td>
                    <td class="auto-style1">
                        <asp:DropDownList ID="ddlSolution" runat="server" CssClass="QueryField" Width="100%" AutoPostBack="True" OnSelectedIndexChanged="ddlSolution_SelectedIndexChanged" meta:resourcekey="ddlSolutionResource1">
                            <asp:ListItem Selected="True" Value="" meta:resourcekey="ListItemResource6">- 未指定 -</asp:ListItem>
                        </asp:DropDownList>
                    </td>
                    <td class="auto-style1">
                        <asp:DropDownList ID="ddlGender" runat="server" CssClass="QueryField" Width="100%" AutoPostBack="True" OnSelectedIndexChanged="ddlGender_SelectedIndexChanged" meta:resourcekey="ddlGenderResource1">
                            <asp:ListItem Selected="True" Value="" meta:resourcekey="ListItemResource7">- 未指定 -</asp:ListItem>
                        </asp:DropDownList>
                    </td>
                    <td class="auto-style1">
                        <asp:DropDownList ID="ddlExpectdate" runat="server" CssClass="QueryField" Width="100%" meta:resourcekey="ddlExpectdateResource1">
                            <asp:ListItem Selected="True" Value="" meta:resourcekey="ListItemResource8">- 未指定 -</asp:ListItem>
                        </asp:DropDownList>
                    </td>
                    <td class="auto-style1">
                        <asp:DropDownList ID="ddlSeconddate" runat="server" CssClass="QueryField" Width="100%" meta:resourcekey="ddlSeconddateResource1">
                ...
                <tr>
                    <td>
                        <asp:DropDownList ID="ddlSecondsolution1" runat="server" CssClass="QueryField" Width="100%" meta:resourcekey="ddlSecondsolution1Resource1">
                            <asp:ListItem Selected="True" Value="" meta:resourcekey="ListItemResource10">- 未指定 -</asp:ListItem>
                        </asp:DropDownList>
                    </td>
                    <td>
                        <asp:DropDownList ID="ddlSecondsolution2" runat="server" CssClass="QueryField" Width="100%" meta:resourcekey="ddlSecondsolution2Resource1">
                            <asp:ListItem Selected="True" Value="" meta:resourcekey="ListItemResource11">- 未指定 -</asp:ListItem>
                        </asp:DropDownList>
                    </td>
                    <td>
                        <asp:DropDownList ID="ddlSecondsolution3" runat="server" CssClass="QueryField" Width="100%" meta:resourcekey="ddlSecondsolution3Resource1">
                ...
                <tr>
                    ...
                    <td colspan="2" style="vertical-align: top;">
                        ...
                        <asp:TextBox ID="txtOrther" runat="server" CssClass="QueryField" Enabled="False" meta:resourcekey="txtOrtherResource1"></asp:TextBox>
                    ...
                    <td style="vertical-align: top;">
                        <asp:DropDownList ID="ddlMeal" runat="server" CssClass="QueryField" Width="100%" meta:resourcekey="ddlMealResource1">
                            ...
                            <asp:ListItem Value="西式" meta:resourcekey="ListItemResource14">西式</asp:ListItem>
                            <asp:ListItem Value="中式" meta:resourcekey="ListItemResource15">中式</asp:ListItem>
                            <asp:ListItem Value="素食" meta:resourcekey="ListItemResource16">素食</asp:ListItem>
                        </asp:DropDownList>
                    </td>
                </tr>
                <tr class="FormTRStyle">
            ...
            <asp:Label ID="Label1" runat="server" Text="- 未指定 -" Visible="False" meta:resourcekey="Label1Resource1"></asp:Label>
            ...
            <asp:Button ID="btnGoBackPage" runat="server" Text="Button" OnClick="btnGoBackPage_Click" Style="display: none;" meta:resourcekey="btnGoBackPageResource1" />
            ...
            <asp:Label ID="lblIDFormatErr" runat="server" Text="身份證字號格式錯誤。" Visible="False" meta:resourcekey="lblIDFormatErrResource1"></asp:Label>
