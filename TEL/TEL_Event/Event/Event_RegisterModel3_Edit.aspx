<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Event.master" AutoEventWireup="true" CodeFile="Event_RegisterModel3_Edit.aspx.cs" Inherits="Event_Event_RegisterModel3_Edit" StylesheetTheme="Event" Culture="auto" UICulture="auto" %>
        ...
        <ContentTemplate>
            <table>
                ...
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="txtExamineebirthday" runat="server" CssClass="QueryField"></asp:TextBox>
                    </td>
                    <td>
            ...
            <asp:Label ID="lblIDFormatErr" runat="server" Text="身份證字號格式錯誤。" Visible="false"></asp:Label>
        </ContentTemplate>
        <Triggers>
