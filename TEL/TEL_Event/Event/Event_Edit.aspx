...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <table>
        <tr>
            ...
            <td style="border-bottom: 1.5px solid #19b1e5;">
                <asp:Label ID="lblPageName" runat="server" CssClass="PageTitle" Text="編輯活動"></asp:Label>
            </td>
        </tr>
    ...
    <table>
        ...
        <tr>
            <td colspan="3">
                <asp:Label ID="lblThumbnailName" runat="server" Text="" ></asp:Label>
        ...
        <tr>
            <td colspan="3">
                <asp:Label ID="lblPictureName" runat="server" Text="" ></asp:Label>
