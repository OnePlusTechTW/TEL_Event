<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Event_RegisterModel3_View.aspx.cs" Inherits="Event_Event_RegisterModel3_View" culture="auto" meta:resourcekey="PageResource2" uiculture="auto" %>
        ...
        <div>
            ...
            <table>
                ...
                <tr class="FormTRStyle">
                    ...
                    <td>
                        <asp:Label ID="lblSecondsolution3" runat="server" Text="健檢次方案2" meta:resourcekey="lblSecondsolution3Resource1"></asp:Label>
                    </td>
                    <td></td>
                    <td></td>
                    <td></td>
