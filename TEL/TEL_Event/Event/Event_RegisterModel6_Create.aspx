<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Event.master" AutoEventWireup="true" CodeFile="Event_RegisterModel6_Create.aspx.cs" Inherits="Event_Event_RegisterModel6_Create" StylesheetTheme="Event" Culture="auto" UICulture="auto" meta:resourcekey="PageResource2" %>
        ...
        <ContentTemplate>
            <table>
                ...
                <tr class="FormTRStyle">
                    <td>
                        <asp:Label ID="lblChangeArea" runat="server" Text="地點" meta:resourcekey="lblChangeAreaResource1"></asp:Label>
                    </td>
                    <td>
                        <asp:Label ID="lblChangeDate" runat="server" Text="日期時間" meta:resourcekey="lblChangeDateResource1"></asp:Label>
                    </td>
                    <td colspan="3"></td>
                </tr>
                <tr>
                    ...
                    <td>
                        <asp:DropDownList ID="ddlAvaliabledate" runat="server" CssClass="QueryField" Enabled="False" Width="100%" meta:resourcekey="ddlAvaliabledateResource1">
                            <asp:ListItem Selected="True" Value="" meta:resourcekey="ListItemResource2">- 未指定 -</asp:ListItem>
                        </asp:DropDownList>
                    </td>
                    <td colspan="3"></td>
                </tr>
