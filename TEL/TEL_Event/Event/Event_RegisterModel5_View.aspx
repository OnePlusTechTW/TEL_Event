    ...
    <form id="form1" runat="server">
        <div>
            ...
            <table>
                ...
                <tr>
                    <td colspan="3">
                        <asp:TextBox ID="txtDescription1" runat="server" CssClass="QueryField" TextMode="MultiLine" Width="100%" Height="60px" Enabled="false"></asp:TextBox>
                    </td>
                    <td colspan="2"></td>
                </tr>
                <tr class="FormTRStyle">
                ...
                <tr>
                    <td colspan="3">
                        <asp:TextBox ID="txtDescription2" runat="server" CssClass="QueryField" TextMode="MultiLine" Width="100%" Height="60px" Enabled="false"></asp:TextBox>
                    </td>
                    <td colspan="2"></td>
                </tr>
                <tr class="FormTRStyle">
                ...
                <tr>
                    <td colspan="3">
                        <asp:TextBox ID="txtDescription3" runat="server" CssClass="QueryField" TextMode="MultiLine" Width="100%" Height="60px" Enabled="false"></asp:TextBox>
                    </td>
                    <td colspan="2"></td>
                </tr>
                <tr class="FormTRStyle">
