<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Event.master" AutoEventWireup="true" CodeFile="Event_RegisterModel2_Edit.aspx.cs" Inherits="Event_Event_RegisterModel2_Edit" StylesheetTheme="Event" Culture="auto" UICulture="auto" meta:resourcekey="PageResource2" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <table>
        ...
        <tr>
            ...
            <td>
                <asp:TextBox ID="txtFID" MaxLength="10" runat="server" CssClass="QueryField" meta:resourcekey="txtFIDResource1"></asp:TextBox>
            </td>
            <td>
